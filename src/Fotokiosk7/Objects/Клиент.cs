...
namespace IIS.Fotokiosk7
{
    ...
    public class Клиент : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Fotokiosk7.Оплата fОплата;
        
        private IIS.Fotokiosk7.ОтправНаПочту fОтправНаПочту;
        ...
        [PropertyStorage(new string[] {
                "Оплата"})]
        [NotNull()]
        public virtual IIS.Fotokiosk7.Оплата Оплата
        {
            get
            {
                ...
                IIS.Fotokiosk7.Оплата result = this.fОплата;
        ...
        [PropertyStorage(new string[] {
                "ОтправНаПочту"})]
        [NotNull()]
        public virtual IIS.Fotokiosk7.ОтправНаПочту ОтправНаПочту
        {
            get
            {
                ...
                IIS.Fotokiosk7.ОтправНаПочту result = this.fОтправНаПочту;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КлиентE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентE", typeof(IIS.Fotokiosk7.Клиент));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КлиентL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентL", typeof(IIS.Fotokiosk7.Клиент));
                }
            }
        }
    }
