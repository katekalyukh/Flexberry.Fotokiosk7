...
namespace IIS.Fotokiosk7
{
    ...
    public class ДопНастройки : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Fotokiosk7.СделатьФото.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДопНастройкиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДопНастройкиE", typeof(IIS.Fotokiosk7.ДопНастройки));
                }
            }
        }
    }
    ...
    public class DetailArrayOfДопНастройки : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Fotokiosk7.DetailArrayOfДопНастройки members)

        // *** End programmer edit section *** (IIS.Fotokiosk7.DetailArrayOfДопНастройки members)
        ...
        /// </summary>
        public DetailArrayOfДопНастройки(IIS.Fotokiosk7.СделатьФото fСделатьФото) : 
                base(typeof(ДопНастройки), ((ICSSoft.STORMNET.DataObject)(fСделатьФото)))
        {
        }
        
        public IIS.Fotokiosk7.ДопНастройки this[int index]
        {
            get
            {
                return ((IIS.Fotokiosk7.ДопНастройки)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Fotokiosk7.ДопНастройки dataobject)
        {
